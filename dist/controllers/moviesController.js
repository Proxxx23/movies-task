...
const add = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const genresRepository = (0, genresRepository_1.createGenresRepository)();
    ...
    const movie = (0, movieFactory_1.createMovieFromRequest)(req.body);
    const moviesRepository = (0, moviesRepository_1.createMoviesRepository)();
    try {
...
const search = (req, res) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    const moviesService = new moviesService_1.MoviesService((0, moviesRepository_1.createMoviesRepository)());
